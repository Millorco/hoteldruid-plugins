...
Le prove sono state fatte su un'installazione reale di prova di HotelDruid 3.0.8, con il modello email 8 trasformato in HTML.

| Prova | Risultato |
|-------|-----------|
| `php -l` su `plugin.php` e `lingue.php` | nessun errore |
| Email HTML con variabili da prenotazione | un solo riquadro con testo formattato e variabili sostituite; riga Ccn |
| Pulsante `< >`, modifica dell'HTML, ritorno al testo | vista aggiornata; il modulo invia il testo modificato e gli stessi campi dell'originale |
